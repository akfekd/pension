...
<script type="text/javascript">
    function sendOk() {
        ...
        if(!str) {
   		...
   		f.action="${pageContext.request.contextPath}/festival/${mode}_ok.do";
			  ...
			  <table style="width: 100%; border-spacing: 0px;">
			     <tr height="45"> 
			      <td align="center" >
			        ...
			        <button type="button" class="btn" onclick="javascript:location.href='${pageContext.request.contextPath}/festival/list.do';">${mode=='created'?'등록취소':'수정취소'}</button>
			      </td>
			    </tr>
			  </table>
			</form>
